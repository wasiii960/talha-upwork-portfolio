...
const edges: Record<Variant, [number, number][]> = {
  integration: [[0, 3], [1, 3], [2, 3], [3, 4], [3, 5]],
  lims: [[0, 1], [0, 2], [1, 3], [2, 3], [3, 4], [3, 5]],
  orders: [[0, 2], [1, 2], [2, 3], [2, 4], [2, 5]],
  modernisation: [[0, 1], [0, 2], [1, 3], [1, 4], [2, 4], [2, 5]],
  cloud: [[0, 2], [1, 2], [2, 3], [2, 4], [2, 5]],
  gateway: [[0, 1], [1, 2], [1, 3], [1, 4], [4, 5], [3, 5], [2, 5]],
};
